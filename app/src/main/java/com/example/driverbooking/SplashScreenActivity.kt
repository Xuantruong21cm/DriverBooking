...
class SplashScreenActivity : AppCompatActivity() {
        ...
        listener = FirebaseAuth.AuthStateListener { myFirebaseAuth ->
            ...
            if (user != null) {
                FirebaseInstanceId.getInstance().instanceId.addOnFailureListener { e ->
                    ...
                    Log.d("TOKEN", instanceResult.token)
                    UserUtils.updateToken(this@SplashScreenActivity, instanceResult.token)
                }
    ...
    private fun showRegisterLayout() {
        ...
        val itemView =
            LayoutInflater.from(this@SplashScreenActivity).inflate(R.layout.layout_register, null)
